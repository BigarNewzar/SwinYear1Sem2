...
namespace Swin_Adventure
{
    public class LookCommand : Command
    {
        ...
        public override string Execute(Player p, string[] text)
        {
            ...
            if (text.Length == 1 && text[0] == "look")//didnt set location in main code yet!
            {
                return "You are currently in:\t" + p.Location.FirstID + "\nDetails about the place:\t" + p.Location.FullDescription;

            }

            //maybe can make it into else if it causes errors?
            //not 3 or 5 elements
